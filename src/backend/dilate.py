...
def dilate_image(img, kernel_size):
    ...
    # Função para obter o maior valor entre os vizinhos
    def compute_center(neighbours):
        return np.max(neighbours)

    # Convolução para dilatação
...
if __name__ == "__main__":
    ...
    dilated_img.save("dilatado.jpg")  # Salvar a imagem dilatada
